...
import com.pbs.dto.AccountsContactInfoDto;
...
public class AccountsController {
    ...
    public AccountsController(IAccountsService service) { // Recommended Approach
    ...
    @Operation(
            summary = "Fetch build Info of the application",
            description = "Rest API to fetch the build info of the application"
    )
    @ApiResponses({
            @ApiResponse(
                   responseCode = "200",
    ...
    @Operation(
            summary = "Fetch Java version of the application",
    ...
    @Operation(
            summary = "Fetch Contacts info of the application",
            description = "Rest API to fetch the Contacts info of the application"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
